...
def generate_conflict_map(data, selected_date, event_type, civilian_targeting):
    ...
    # 🟦 1. Blue density map for general intensity
    ...
    # 🔴 2. Sub-event type markers (colored and in legend)
...
def main(data, ukraine_geojson, min_date, max_date):
    # === Section 1: Autoplay Conflict Overview Animation ===
    ...
    # === Section 2: Interactive Conflict Map ===
    ...
    # === Define timeline months + descriptions ===
    month_descriptions = {
    ...
    selected_event_type = st.selectbox("Event Type", options=event_type_options)

    # === Filter: Civilian Targeting ===
